              ...
              <v-col cols="12">
                <v-row no-gutters>
                  <v-col cols="6" class="ps-2 pe-2">
                    ...
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase card-title-secondary">Order Date</p>
                      <p class="text-capitalize card-text-desc">30 Sep, 2025</p>
                    </div>
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase card-title-secondary">Due Date</p>
                      <p class="text-capitalize card-text-desc">30 Sep, 2025</p>
                    </div>
                  </v-col>
                  <v-col cols="6" class="ps-2 pe-2">
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase card-title-secondary">Assign to</p>
                      <p class="text-capitalize card-text-desc">John Doe</p>
                    </div>
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase card-title-secondary">Payment term</p>
                  ...
                  <v-col cols="4">
                    <div class="d-flex flex-row justify-space-between">
                      ...
                      <div class="d-flex flex-column">
                        <span class="text-capitalize card-text-desc">Nike 23KJ</span>
                        <span class="text-uppercase card-text-desc">SKU:ADDS-GRS-22</span>
                      </div>
                    </div>
                  </v-col>
                  <v-col cols="2" class="pt-6"><span class="card-text-desc">2(pcs)</span></v-col>
                  <v-col cols="2" class="pt-6"><span class="card-text-desc">24.00</span></v-col>
                  <v-col cols="2" class="pt-6"><span class="card-text-desc">10%</span></v-col>
                  <v-col cols="2" class="pt-6"><span class="card-text-desc">58.00</span></v-col>
                </v-row>
                <v-row no-gutters>
                  <v-col cols="6" offset="6">
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase ps-3 card-title-secondary">SUB Total</p>
                      <p class="card-text-desc">58.00</p>
                    </div>
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase ps-3 card-title-secondary">Total Quantity</p>
                      <p class="card-text-desc"> 2 </p>
                    </div>
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-uppercase ps-3 card-title-secondary">Discont</p>
                      <p class="card-text-desc"> - </p>
                    </div>
                    <div class="d-flex flex-row justify-space-between">
                      <p class="text-capitalize ps-3 card-title-secondary">Total</p>
                      <p class="card-text-desc">58.00</p>
                    </div>
                  </v-col>
                </v-row>
              ...
              <v-card class="sales-order-card">
                ...
                <v-card class="mt-1 mb-2 invoice-card">
                  <div class="d-flex flex-row justify-space-between">
                    ...
                    <span  class="invoice-link" @click="openModalInvoice">View Invoice</span>
                  </div>
                  <div class="d-flex flex-row justify-space-between">
                  ...
                  <div class="d-flex flex-row justify-center pt-2 pb-2">
                    <v-btn class="payment-btn" @click="openModalRecordPayment">Record payment</v-btn>
                  </div>
                </v-card>
                <h4 class="card-title">Contact Person</h4>
                <v-card class="mt-1 mb-2 customer-card">
                  <div class="d-flex flex-row pb-2">
                    <img :src="client_photo" alt="" class="img-client-photo-invoice">
                    <h3 class="text-capitalize ps-2 pt-3">Cameron Williamson</h3>
                  </div>
